...
<body>{{-- --}}
   ...
   <div class="container">
       <a href="{{route("produto.create")}}" class="btn btn-success" >Criar um Produto </a>
       <a href="{{route("tipoproduto.index")}}" class="btn btn-outline-warning" >Ir para tipoProduto </a>
     ...
     <div class="modal-dialog">
        <div class="modal-content">
         <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Renover Produto</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                 <div class="modal-body">
                 Deseja mesmo remover este produto?
